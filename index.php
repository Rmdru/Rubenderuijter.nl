            ...
            <div class="timeline animatedContainer">
                <div class="container left animationSlideLeft">
                    <div class="content">
                        ...
                        <p class="txt"><b>Januari 2024 t/m heden<br /><br />Functie:</b> Back-end Developer<br /><br /><b>Dienstverband:</b> Afstudeerstage<br /><br />Tijdens deze afstudeerstage bouw ik 'from scratch' een voorraadbeheer-applictie. Dit doe ik met Laravel en Splade.</p>
                        <a class="primaryBtn animated fullWidth" rel="noopener" target="_blank" href="https://comfycoders.nl/">Meer informatie <i class="material-icons">keyboard_arrow_right</i></a>
                    </div>
                </div>
                <div class="container right animationSlideRight">
                    <div class="content">
                        <h2 class="title">DHL</h2>
                        <p class="txt"><b>April 2023 t/m heden<br /><br />Functie:</b> Bezorger<br /><br /><b>Dienstverband:</b> Parttime</p>
                        <a class="primaryBtn animated fullWidth" rel="noopener" target="_blank" href="https://www.dhl.nl/">Meer informatie <i class="material-icons">keyboard_arrow_right</i></a>
                    </div>
                </div>
                <div class="container left animationSlideLeft">
                    <div class="content">
