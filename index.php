            ...
            <div class="timeline animatedContainer">
                <div class="container left animationSlideLeft">
                    <div class="content">
                        ...
                        <p class="txt"><b>April 2022 t/m heden<br /><br />Functie:</b> Operator<br /><br /><b>Dienstverband:</b> Parttime<br /><br />Als Operator hou ik de miniatuurwereld in beweging door storingen van treinen en auto's te verhelpen.</p>
                ...
                <div class="container right animationSlideRight">
                    <div class="content">
                        ...
                        <p class="txt"><b>Oktober 2019 t/m heden<br /><br />Functie:</b> Computerspecialist<br /><br /><b>Dienstverband:</b> Parttime<br /><br /><b>Gemiddelde beoordeling:</b> 4,5 ster<br /><br /><b>Aantal tevreden klanten:</b> Meer dan 85<br /><br />Als Computerspecialist help ik mensen met hun computerproblemen en vragen.</p>
                ...
                <div class="container left animationSlideRight">
                    <div class="content">
                ...
                <div class="container right animationSlideRight">
                    <div class="content">
                        ...
                        <p class="txt"><b>November2017 t/m september 2019<br /><br />Functie:</b> Krantenbezorger<br /><br /><b>Dienstverband:</b> Parttime</p>
            ...
            <div class="hiddenWindowBg" id="hiddenSkillsBg">
                ...
                <div class="hiddenWindow">
                    ...
                    <div class="hiddenWindowScrollablePart">
                        ...
                        <div class="progressBarWrapper">
                            <div class="txtWrapper">
                                <p class="txt">Laravel</p>
                                <p class="txt">30%</p>
                            </div>
                            <div class="progressBar">
                                <div class="progressBarProgress progressBarPercent30"></div>
                            </div>
                        </div>
                        <div class="progressBarWrapper">
                            <div class="txtWrapper">
                                <p class="txt">Vue.js</p>
                                <p class="txt">30%</p>
                            </div>
                            <div class="progressBar">
                                <div class="progressBarProgress progressBarPercent30"></div>
                        ...
                        <div class="progressBarWrapper">
                            <div class="txtWrapper">
                                <p class="txt">ASP.NET</p>
                                <p class="txt">10%</p>
                            </div>
                            <div class="progressBar">
                                <div class="progressBarProgress progressBarPercent10"></div>
                            </div>
                        </div>
                        <div class="progressBarWrapper">
                            <div class="txtWrapper">
                        ...
                        <div class="progressBarWrapper">
                            ...
                            <div class="progressBar">
                                <div class="progressBarProgress progressBarPercent5"></div>
                            </div>
                        </div>
                        <div class="progressBarWrapper">
                            <div class="txtWrapper">
